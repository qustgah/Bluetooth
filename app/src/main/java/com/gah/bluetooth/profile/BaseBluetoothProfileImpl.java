 ...
 * @param <T>
 */
public class BaseBluetoothProfileImpl<T extends BluetoothProfile> implements IBluetoothProfile, BluetoothProfile.ServiceListener {
	...
	public BaseBluetoothProfileImpl(Context context, int profile,MyServiceListener listener) {
		this.context = context;
		this.profile = profile;
		this.listener = listener;
		BluetoothAdapter.getDefaultAdapter().getProfileProxy(context, this, profile);
	...
	@Override
	public void close() {
		BluetoothAdapter.getDefaultAdapter().closeProfileProxy(profile, mProxy);
	}
